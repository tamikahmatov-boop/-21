...
ALLOWED_CHAT_ID = os.environ.get("TELEGRAM_CHAT_ID")  # если задано - бот отвечает только этому чату

BYBIT_API_KEY = os.environ["BYBIT_API_KEY"]
BYBIT_API_SECRET = os.environ["BYBIT_API_SECRET"]
BYBIT_TESTNET = os.environ.get("BYBIT_TESTNET", "false").lower() == "true"
BYBIT_CATEGORY = os.environ.get("BYBIT_CATEGORY", "linear")  # linear, inverse, spot

SYNC_INTERVAL_SEC = int(os.environ.get("SYNC_INTERVAL_SEC", "300"))  # раз в 5 минут
INITIAL_BACKFILL_DAYS = int(os.environ.get("INITIAL_BACKFILL_DAYS", "180"))
